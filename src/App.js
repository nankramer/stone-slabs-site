...
const BRANDS = [
  ...
  { slug: "infinity", name: "Infinity", tagline: "Porcelain surfaces", desc: "Infinity porcelain surfaces offer the beauty of natural stone with the performance advantages of advanced ceramics. UV-stable, scratch-resistant, and available in large formats up to 1600×3200mm, the range spans marble book-match, onyx crystal, stone effect, concrete, solid colour, and metal effect collections — perfect for seamless cladding and countertop applications." },
  { slug: "estrella", name: "Estrella", tagline: "Porcelain surfaces", desc: "Estrella porcelain surfaces combine quality with design, offering a curated range of 25 colours and patterns — from dramatic veined Calacattas and bold blacks to warm beiges and statement blues — suited to both residential and commercial projects." },
  { slug: "lutum", name: "Lutum", tagline: "Porcelain surfaces", desc: "Lutum porcelain surfaces are manufactured using cutting-edge technology to produce ultra-compact slabs with exceptional durability, heat resistance, and design versatility. The 10-colour range spans dramatic veined marbles, rich greens, deep blacks, warm travertines, and industrial concretes." },
];

const MATERIALS = [
  // --- Neolith (Porcelain) ---
  { id: 400, name: "Abu Dhabi White", brand: "neolith", type: "Porcelain", colour: "White", pattern: "Veined", finish: ["Polished", "Honed"], apps: ["Kitchens", "Bathrooms", "Cladding"], img: "images/neolith/Abu_Dhabi_White.jpeg" },
  { id: 401, name: "Amazonico", brand: "neolith", type: "Porcelain", colour: "Green", pattern: "Veined", finish: ["Polished"], apps: ["Cladding", "Bathrooms"], img: "images/neolith/Amazonico.jpeg" },
  { id: 402, name: "Arabesque", brand: "neolith", type: "Porcelain", colour: "White", pattern: "Veined", finish: ["Polished", "Honed"], apps: ["Kitchens", "Bathrooms", "Cladding"], img: "images/neolith/Arabesque.jpeg" },
  { id: 403, name: "Arctic White", brand: "neolith", type: "Porcelain", colour: "White", pattern: "Solid", finish: ["Polished", "Honed"], apps: ["Kitchens", "Bathrooms"], img: "images/neolith/Arctic_White.jpeg" },
  { id: 404, name: "Arena", brand: "neolith", type: "Porcelain", colour: "Beige", pattern: "Solid", finish: ["Honed"], apps: ["Kitchens", "Cladding", "Outdoor"], img: "images/neolith/Arena.jpeg" },
  { id: 405, name: "Artisan", brand: "neolith", type: "Porcelain", colour: "Beige", pattern: "Textured", finish: ["Honed"], apps: ["Cladding", "Kitchens"], img: "images/neolith/Artisan.jpeg" },
  { id: 406, name: "Aspen Grey", brand: "neolith", type: "Porcelain", colour: "Grey", pattern: "Textured", finish: ["Honed", "Leathered"], apps: ["Cladding", "Kitchens", "Outdoor"], img: "images/neolith/Aspen_Grey.jpeg" },
  { id: 407, name: "Azahar", brand: "neolith", type: "Porcelain", colour: "White", pattern: "Veined", finish: ["Polished"], apps: ["Kitchens", "Bathrooms"], img: "images/neolith/Azahar.jpeg" },
  { id: 408, name: "Azure", brand: "neolith", type: "Porcelain", colour: "White", pattern: "Veined", finish: ["Polished", "Honed"], apps: ["Kitchens", "Bathrooms"], img: "images/neolith/Azure.jpeg" },
  { id: 409, name: "Barro", brand: "neolith", type: "Porcelain", colour: "Brown", pattern: "Textured", finish: ["Honed"], apps: ["Cladding", "Outdoor"], img: "images/neolith/Barro.jpeg" },
  { id: 410, name: "Basalt Black", brand: "neolith", type: "Porcelain", colour: "Black", pattern: "Textured", finish: ["Honed", "Leathered"], apps: ["Cladding", "Outdoor", "Kitchens"], img: "images/neolith/Basalt_Black.jpeg" },
  { id: 411, name: "Basalt Grey", brand: "neolith", type: "Porcelain", colour: "Grey", pattern: "Textured", finish: ["Honed", "Leathered"], apps: ["Cladding", "Outdoor", "Kitchens"], img: "images/neolith/Basalt_Grey.jpeg" },
  { id: 412, name: "Beton", brand: "neolith", type: "Porcelain", colour: "Grey", pattern: "Textured", finish: ["Honed"], apps: ["Cladding", "Kitchens"], img: "images/neolith/Beton.jpeg" },
  { id: 413, name: "Black Obsession", brand: "neolith", type: "Porcelain", colour: "Black", pattern: "Veined", finish: ["Polished"], apps: ["Kitchens", "Bathrooms", "Cladding"], img: "images/neolith/Black_Obsession.jpeg" },
  { id: 414, name: "Calacatta", brand: "neolith", type: "Porcelain", colour: "White", pattern: "Veined", finish: ["Polished", "Honed"], apps: ["Kitchens", "Bathrooms"], img: "images/neolith/Calacatta.jpeg" },
  { id: 415, name: "Calacatta Gold", brand: "neolith", type: "Porcelain", colour: "White", pattern: "Veined", finish: ["Polished"], apps: ["Kitchens", "Bathrooms"], img: "images/neolith/Calacatta_Gold.jpeg" },
  { id: 416, name: "Calacatta Luxe", brand: "neolith", type: "Porcelain", colour: "White", pattern: "Veined", finish: ["Polished"], apps: ["Kitchens", "Bathrooms", "Cladding"], img: "images/neolith/Calacatta_Luxe.jpeg" },
  { id: 417, name: "Calacatta Roma", brand: "neolith", type: "Porcelain", colour: "White", pattern: "Veined", finish: ["Polished"], apps: ["Kitchens", "Bathrooms"], img: "images/neolith/Calacatta_Roma.jpeg" },
  { id: 418, name: "Calacatta Royale", brand: "neolith", type: "Porcelain", colour: "White", pattern: "Veined", finish: ["Polished", "Honed"], apps: ["Kitchens", "Bathrooms", "Cladding"], img: "images/neolith/Calacatta_Royale.jpeg" },
  { id: 419, name: "Calatorao", brand: "neolith", type: "Porcelain", colour: "Black", pattern: "Veined", finish: ["Polished", "Honed"], apps: ["Kitchens", "Cladding"], img: "images/neolith/Calatorao.jpeg" },
  { id: 420, name: "Calista", brand: "neolith", type: "Porcelain", colour: "White", pattern: "Veined", finish: ["Polished"], apps: ["Kitchens", "Bathrooms"], img: "images/neolith/Calista.jpeg" },
  { id: 421, name: "Cappadocia Sunset", brand: "neolith", type: "Porcelain", colour: "Grey", pattern: "Speckled", finish: ["Honed"], apps: ["Cladding", "Kitchens"], img: "images/neolith/Cappadocia_Sunset.jpeg" },
  { id: 422, name: "Cement", brand: "neolith", type: "Porcelain", colour: "Grey", pattern: "Textured", finish: ["Honed"], apps: ["Cladding", "Kitchens", "Outdoor"], img: "images/neolith/Cement.jpeg" },
  { id: 423, name: "Colorado Dunes", brand: "neolith", type: "Porcelain", colour: "White", pattern: "Veined", finish: ["Polished", "Honed"], apps: ["Kitchens", "Bathrooms"], img: "images/neolith/Colorado_Dunes.jpeg" },
  { id: 424, name: "Creme", brand: "neolith", type: "Porcelain", colour: "Beige", pattern: "Textured", finish: ["Honed"], apps: ["Cladding", "Kitchens"], img: "images/neolith/Creme.jpeg" },
  { id: 425, name: "Estatuario", brand: "neolith", type: "Porcelain", colour: "White", pattern: "Veined", finish: ["Polished", "Honed"], apps: ["Kitchens", "Bathrooms", "Cladding"], img: "images/neolith/Estatuario.jpeg" },
  { id: 426, name: "Everest Sunrise", brand: "neolith", type: "Porcelain", colour: "White", pattern: "Veined", finish: ["Polished"], apps: ["Kitchens", "Bathrooms"], img: "images/neolith/Everest_Sunrise.jpeg" },
  { id: 427, name: "Himalaya Crystal", brand: "neolith", type: "Porcelain", colour: "White", pattern: "Veined", finish: ["Polished"], apps: ["Kitchens", "Bathrooms"], img: "images/neolith/Himalaya_Crystal.jpeg" },
  { id: 428, name: "Ignea", brand: "neolith", type: "Porcelain", colour: "Grey", pattern: "Textured", finish: ["Honed", "Leathered"], apps: ["Cladding", "Outdoor"], img: "images/neolith/Ignea.jpeg" },
  { id: 429, name: "Iron Copper", brand: "neolith", type: "Porcelain", colour: "Brown", pattern: "Textured", finish: ["Honed"], apps: ["Cladding", "Kitchens"], img: "images/neolith/Iron_Copper.jpeg" },
  { id: 430, name: "Iron Corten", brand: "neolith", type: "Porcelain", colour: "Brown", pattern: "Textured", finish: ["Honed"], apps: ["Cladding", "Outdoor"], img: "images/neolith/Iron_Corten.jpeg" },
  { id: 431, name: "Iron Frost", brand: "neolith", type: "Porcelain", colour: "Grey", pattern: "Textured", finish: ["Honed"], apps: ["Cladding", "Kitchens"], img: "images/neolith/Iron_Frost.jpeg" },
  { id: 432, name: "Iron Grey", brand: "neolith", type: "Porcelain", colour: "Grey", pattern: "Textured", finish: ["Honed", "Leathered"], apps: ["Cladding", "Kitchens", "Outdoor"], img: "images/neolith/Iron_Grey.jpeg" },
  { id: 433, name: "Just White", brand: "neolith", type: "Porcelain", colour: "White", pattern: "Solid", finish: ["Polished", "Honed"], apps: ["Kitchens", "Bathrooms"], img: "images/neolith/Just_White.jpeg" },
  { id: 434, name: "Krater", brand: "neolith", type: "Porcelain", colour: "Black", pattern: "Textured", finish: ["Honed", "Leathered"], apps: ["Cladding", "Outdoor"], img: "images/neolith/Krater.jpeg" },
  { id: 435, name: "La Boheme", brand: "neolith", type: "Porcelain", colour: "Beige", pattern: "Wood", finish: ["Honed"], apps: ["Cladding", "Kitchens"], img: "images/neolith/La_Boheme.jpeg" },
  { id: 436, name: "Strata Argentum", brand: "neolith", type: "Porcelain", colour: "Beige", pattern: "Veined", finish: ["Honed"], apps: ["Cladding", "Bathrooms", "Kitchens"], img: "images/neolith/Strata_Argentum.jpeg" },
  { id: 437, name: "Summer Dala", brand: "neolith", type: "Porcelain", colour: "Beige", pattern: "Wood", finish: ["Honed"], apps: ["Cladding", "Kitchens"], img: "images/neolith/Summer_Dala.jpeg" },
  { id: 438, name: "Taj Mahal", brand: "neolith", type: "Porcelain", colour: "White", pattern: "Veined", finish: ["Polished", "Honed"], apps: ["Kitchens", "Bathrooms", "Cladding"], img: "images/neolith/Taj_Mahal.jpeg" },
  { id: 439, name: "Terrazo Ceppo", brand: "neolith", type: "Porcelain", colour: "Grey", pattern: "Speckled", finish: ["Honed"], apps: ["Kitchens", "Cladding", "Bathrooms"], img: "images/neolith/Terrazo_Ceppo.jpeg" },
  { id: 440, name: "Victoria", brand: "neolith", type: "Porcelain", colour: "Black", pattern: "Veined", finish: ["Polished", "Honed"], apps: ["Kitchens", "Bathrooms", "Cladding"], img: "images/neolith/Victoria.jpeg" },
  { id: 441, name: "White Sands", brand: "neolith", type: "Porcelain", colour: "White", pattern: "Textured", finish: ["Polished", "Honed"], apps: ["Kitchens", "Bathrooms"], img: "images/neolith/WhiteSands.jpeg" },
  { id: 442, name: "Wulong", brand: "neolith", type: "Porcelain", colour: "Grey", pattern: "Speckled", finish: ["Honed"], apps: ["Cladding", "Kitchens", "Outdoor"], img: "images/neolith/Wulong.jpeg" },
  { id: 443, name: "Zaha Stone", brand: "neolith", type: "Porcelain", colour: "Grey", pattern: "Veined", finish: ["Polished", "Honed"], apps: ["Kitchens", "Bathrooms", "Cladding"], img: "images/neolith/Zaha_Stone.jpeg" },
  // --- Eezi Quartz ---
  ...
  // --- Lutum (Porcelain) ---
  { id: 300, name: "Griseo", brand: "lutum", type: "Porcelain", colour: "Grey", pattern: "Textured", finish: ["Honed"], apps: ["Kitchens", "Cladding", "Bathrooms"], img: "images/lutum/Lutum-Griseo.jpg" },
  { id: 301, name: "Nebula", brand: "lutum", type: "Porcelain", colour: "White", pattern: "Veined", finish: ["Polished", "Honed"], apps: ["Kitchens", "Cladding", "Bathrooms"], img: "images/lutum/Lutum-Nebula.jpg" },
  { id: 302, name: "Laurentia", brand: "lutum", type: "Porcelain", colour: "Black", pattern: "Veined", finish: ["Polished", "Honed"], apps: ["Kitchens", "Cladding"], img: "images/lutum/Lutum-Laurentia.jpg" },
  { id: 303, name: "Aureus", brand: "lutum", type: "Porcelain", colour: "White", pattern: "Veined", finish: ["Polished"], apps: ["Kitchens", "Cladding", "Bathrooms"], img: "images/lutum/Lutum-Aureus.jpg" },
  { id: 304, name: "Umbra", brand: "lutum", type: "Porcelain", colour: "Black", pattern: "Textured", finish: ["Honed", "Leathered"], apps: ["Cladding", "Kitchens", "Outdoor"], img: "images/lutum/Lutum-Umbra.jpg" },
  { id: 305, name: "Traverto", brand: "lutum", type: "Porcelain", colour: "Beige", pattern: "Veined", finish: ["Honed"], apps: ["Cladding", "Bathrooms", "Kitchens"], img: "images/lutum/Traverto-lutum-new.jpeg" },
  { id: 306, name: "Palati", brand: "lutum", type: "Porcelain", colour: "Beige", pattern: "Veined", finish: ["Polished", "Honed"], apps: ["Kitchens", "Cladding", "Bathrooms"], img: "images/lutum/Lutum-Palati.jpg" },
  { id: 307, name: "Niveus", brand: "lutum", type: "Porcelain", colour: "Beige", pattern: "Veined", finish: ["Polished"], apps: ["Kitchens", "Bathrooms"], img: "images/lutum/Lutum-Niveus.jpg" },
  { id: 308, name: "Folias", brand: "lutum", type: "Porcelain", colour: "Green", pattern: "Veined", finish: ["Polished"], apps: ["Cladding", "Bathrooms"], img: "images/lutum/Lutum-Folias.jpg" },
  { id: 309, name: "Oculus", brand: "lutum", type: "Porcelain", colour: "White", pattern: "Veined", finish: ["Polished"], apps: ["Kitchens", "Cladding", "Bathrooms"], img: "images/lutum/Lutum-Oculus.jpg" },
  // --- Estrella (Quartz Surfaces) ---
  { id: 200, name: "Absolute White", brand: "estrella", type: "Porcelain", colour: "White", pattern: "Solid", finish: ["Polished"], apps: ["Kitchens", "Bathrooms"], img: "images/estrella/Absolute_White.png" },
  { id: 201, name: "Amani Crema", brand: "estrella", type: "Porcelain", colour: "Beige", pattern: "Veined", finish: ["Polished"], apps: ["Kitchens", "Bathrooms"], img: "images/estrella/Amani_Crema.png" },
  { id: 202, name: "Amani Grey", brand: "estrella", type: "Porcelain", colour: "Grey", pattern: "Veined", finish: ["Polished"], apps: ["Kitchens", "Bathrooms", "Staircases"], img: "images/estrella/Amani_Grey.png" },
  { id: 203, name: "Ankara", brand: "estrella", type: "Porcelain", colour: "White", pattern: "Veined", finish: ["Polished"], apps: ["Kitchens", "Bathrooms"], img: "images/estrella/Ankara.png" },
  { id: 204, name: "Arabescato Corchia", brand: "estrella", type: "Porcelain", colour: "White", pattern: "Veined", finish: ["Polished"], apps: ["Kitchens", "Bathrooms", "Cladding"], img: "images/estrella/Arabescato_Corchia.png" },
  { id: 205, name: "Basalt Black", brand: "estrella", type: "Porcelain", colour: "Black", pattern: "Solid", finish: ["Polished", "Honed"], apps: ["Kitchens", "Bathrooms", "Cladding"], img: "images/estrella/Basalt_Black.png" },
  { id: 206, name: "Brown Positano", brand: "estrella", type: "Porcelain", colour: "Brown", pattern: "Textured", finish: ["Polished"], apps: ["Kitchens", "Bathrooms"], img: "images/estrella/Brown_Positano.png" },
  { id: 207, name: "Calacatta Black", brand: "estrella", type: "Porcelain", colour: "Black", pattern: "Veined", finish: ["Polished"], apps: ["Kitchens", "Bathrooms", "Cladding"], img: "images/estrella/Calacatta_Black.png" },
  { id: 208, name: "Calacatta Butterfly", brand: "estrella", type: "Porcelain", colour: "White", pattern: "Veined", finish: ["Polished"], apps: ["Kitchens", "Bathrooms"], img: "images/estrella/Calacatta_Butterfly.png" },
  { id: 209, name: "Calacatta Extra", brand: "estrella", type: "Porcelain", colour: "White", pattern: "Veined", finish: ["Polished"], apps: ["Kitchens", "Bathrooms"], img: "images/estrella/Calacatta_Extra.png" },
  { id: 210, name: "Calacatta Gold", brand: "estrella", type: "Porcelain", colour: "White", pattern: "Veined", finish: ["Polished"], apps: ["Kitchens", "Bathrooms"], img: "images/estrella/Calacatta_Gold.png" },
  { id: 211, name: "Emperor Onyx", brand: "estrella", type: "Porcelain", colour: "Beige", pattern: "Veined", finish: ["Polished"], apps: ["Kitchens", "Bathrooms", "Cladding"], img: "images/estrella/Emperor_Onyx.png" },
  { id: 212, name: "Galaxy", brand: "estrella", type: "Porcelain", colour: "Grey", pattern: "Veined", finish: ["Polished"], apps: ["Kitchens", "Bathrooms"], img: "images/estrella/Galaxy.png" },
  { id: 213, name: "Galaxy Beige", brand: "estrella", type: "Porcelain", colour: "Beige", pattern: "Veined", finish: ["Polished"], apps: ["Kitchens", "Bathrooms"], img: "images/estrella/Galaxy_Beige.png" },
  { id: 214, name: "Illumina Stone", brand: "estrella", type: "Porcelain", colour: "Grey", pattern: "Veined", finish: ["Polished"], apps: ["Kitchens", "Bathrooms", "Staircases"], img: "images/estrella/Illumina_Stone.png" },
  { id: 215, name: "Kylin", brand: "estrella", type: "Porcelain", colour: "Green", pattern: "Veined", finish: ["Polished"], apps: ["Kitchens", "Bathrooms", "Cladding"], img: "images/estrella/Kylin.png" },
  { id: 216, name: "Lassi Transparenti", brand: "estrella", type: "Porcelain", colour: "White", pattern: "Veined", finish: ["Polished"], apps: ["Kitchens", "Bathrooms"], img: "images/estrella/Lassi_Transparenti.png" },
  { id: 217, name: "Luxe Firenze", brand: "estrella", type: "Porcelain", colour: "White", pattern: "Veined", finish: ["Polished"], apps: ["Kitchens", "Bathrooms"], img: "images/estrella/Luxe_Firenze.png" },
  { id: 218, name: "Nero Elegance", brand: "estrella", type: "Porcelain", colour: "Black", pattern: "Veined", finish: ["Polished"], apps: ["Kitchens", "Bathrooms", "Cladding"], img: "images/estrella/Nero_Elegance.png" },
  { id: 219, name: "Ocean Blue", brand: "estrella", type: "Porcelain", colour: "Blue", pattern: "Veined", finish: ["Polished"], apps: ["Bathrooms", "Cladding"], img: "images/estrella/Ocean_Blue.png" },
  { id: 220, name: "Onice White", brand: "estrella", type: "Porcelain", colour: "White", pattern: "Veined", finish: ["Polished"], apps: ["Kitchens", "Bathrooms"], img: "images/estrella/Onice_White.png" },
  { id: 221, name: "Pandora", brand: "estrella", type: "Porcelain", colour: "White", pattern: "Veined", finish: ["Polished"], apps: ["Kitchens", "Bathrooms", "Cladding"], img: "images/estrella/Pandora.png" },
  { id: 222, name: "Savoia Antracite", brand: "estrella", type: "Porcelain", colour: "Grey", pattern: "Textured", finish: ["Polished", "Honed"], apps: ["Kitchens", "Bathrooms", "Cladding"], img: "images/estrella/Savoia_Antracite.png" },
  { id: 223, name: "Taj Mahal", brand: "estrella", type: "Porcelain", colour: "White", pattern: "Veined", finish: ["Polished"], apps: ["Kitchens", "Bathrooms"], img: "images/estrella/Taj_Mahal.png" },
  { id: 224, name: "Travertino Classico", brand: "estrella", type: "Porcelain", colour: "White", pattern: "Veined", finish: ["Polished"], apps: ["Kitchens", "Bathrooms", "Cladding"], img: "images/estrella/Travertino_Classico.png" },
  // --- Infinity (Porcelain Surfaces) ---
  // Marble Book Match Series
  { id: 100, name: "Sahara Noir", code: "MB10", brand: "infinity", type: "Porcelain", colour: "Black", pattern: "Veined", finish: ["Satin"], apps: ["Kitchens", "Cladding", "Bathrooms"], img: "images/infinity/MB10-Sahara-Noir_400x800.jpg" },
  { id: 101, name: "Calacatta Hermitage", code: "MB17", brand: "infinity", type: "Porcelain", colour: "White", pattern: "Veined", finish: ["Satin"], apps: ["Kitchens", "Cladding", "Bathrooms"], img: "images/infinity/MB17-Calacatta-Hermitage_400x800.jpg" },
  { id: 102, name: "Panda White", code: "MB18", brand: "infinity", type: "Porcelain", colour: "White", pattern: "Veined", finish: ["Polished"], apps: ["Kitchens", "Cladding", "Bathrooms"], img: "images/infinity/MB18-Panda-White_400x800.jpg" },
  { id: 103, name: "Royal Peacock", code: "MB20", brand: "infinity", type: "Porcelain", colour: "Green", pattern: "Veined", finish: ["Polished"], apps: ["Cladding", "Bathrooms"], img: "images/infinity/MB20-Royal-Peacock_400x800.jpg" },
  { id: 104, name: "Renoir", code: "MB02", brand: "infinity", type: "Porcelain", colour: "White", pattern: "Veined", finish: ["Polished"], apps: ["Kitchens", "Cladding", "Bathrooms"], img: "images/infinity/Infinity_MB02_Renoir_160x320_12mm-400x800.jpg" },
  { id: 105, name: "Classic Statuario", code: "MB03", brand: "infinity", type: "Porcelain", colour: "White", pattern: "Veined", finish: ["Satin"], apps: ["Kitchens", "Cladding", "Bathrooms"], img: "images/infinity/Infinity_MB03_Classic_Statuario_160x320_12mm-B-400x797.jpg" },
  { id: 106, name: "Calacatta Oro", code: "MB06", brand: "infinity", type: "Porcelain", colour: "White", pattern: "Veined", finish: ["Satin"], apps: ["Kitchens", "Cladding", "Bathrooms"], img: "images/infinity/Infinity_MB06_Calacatta_Oro_160x320_12mm.jpg" },
  { id: 107, name: "Calacatta Magnifico", code: "MB16", brand: "infinity", type: "Porcelain", colour: "White", pattern: "Veined", finish: ["Satin"], apps: ["Kitchens", "Cladding", "Bathrooms"], img: "images/infinity/MB16-Calacatta-Magnifico.jpg" },
  { id: 108, name: "Pietra Grey", code: "MB09", brand: "infinity", type: "Porcelain", colour: "Grey", pattern: "Veined", finish: ["Satin"], apps: ["Kitchens", "Cladding"], img: "images/infinity/Infinity_MB09_Pietra_Grey160x320_12mm.jpg" },
  { id: 109, name: "Nero Marquinia", code: "MB11", brand: "infinity", type: "Porcelain", colour: "Black", pattern: "Veined", finish: ["Polished", "Satin"], apps: ["Kitchens", "Cladding", "Bathrooms"], img: "images/infinity/Infinity_MB11_Spanish_Blacjk_160x320_12mm.jpg" },
  { id: 110, name: "Tundra Select", code: "MB13", brand: "infinity", type: "Porcelain", colour: "Beige", pattern: "Veined", finish: ["Polished", "Satin"], apps: ["Kitchens", "Cladding", "Bathrooms"], img: "images/infinity/TundraSelect-MB13-1.jpg" },
  { id: 111, name: "Pulpis Brown", code: "MB08", brand: "infinity", type: "Porcelain", colour: "Brown", pattern: "Veined", finish: ["Satin"], apps: ["Kitchens", "Cladding"], img: "images/infinity/Infinity_MB08_Pulpis_Brown_400x800.jpg" },
  // Onyx Crystal Series
  { id: 112, name: "Crystal Ice", code: "OC01", brand: "infinity", type: "Porcelain", colour: "Beige", pattern: "Veined", finish: ["Polished"], apps: ["Kitchens", "Cladding", "Bathrooms"], img: "images/infinity/CrystalAmber-OC02-1.jpg" },
  { id: 113, name: "Ocean Blue", code: "OC03", brand: "infinity", type: "Porcelain", colour: "Blue", pattern: "Veined", finish: ["Polished"], apps: ["Cladding", "Bathrooms"], img: "images/infinity/Infinity_OC03_Ocean-Blue_400x800.jpg" },
  { id: 114, name: "Magellano", code: "OC04", brand: "infinity", type: "Porcelain", colour: "Beige", pattern: "Veined", finish: ["Polished"], apps: ["Cladding", "Bathrooms"], img: "images/infinity/OC04-Magellano_400x800.jpg" },
  { id: 115, name: "Thunderstorm", code: "OC05", brand: "infinity", type: "Porcelain", colour: "Blue", pattern: "Textured", finish: ["Pearl"], apps: ["Cladding", "Bathrooms"], img: "images/infinity/OC05-Thunderstorm_400x800.jpg" },
  // Stone Effect Series
  { id: 116, name: "Chianca di Ostuni", code: "SE01", brand: "infinity", type: "Porcelain", colour: "Beige", pattern: "Textured", finish: ["Honed"], apps: ["Cladding", "Bathrooms", "Outdoor"], img: "images/infinity/Infinity_SE01_Chianca_di_Ostuni_160x320_12mm.jpg" },
  { id: 117, name: "Milan Stone", code: "SE03", brand: "infinity", type: "Porcelain", colour: "Grey", pattern: "Speckled", finish: ["Honed"], apps: ["Cladding", "Kitchens", "Outdoor"], img: "images/infinity/Infinity_SE03_Milan_Stone_160x320_12mm.jpg" },
  { id: 118, name: "Travertino Grey", code: "SE06", brand: "infinity", type: "Porcelain", colour: "Grey", pattern: "Veined", finish: ["Honed"], apps: ["Cladding", "Bathrooms", "Outdoor"], img: "images/infinity/TravertinoGrey-SE06.jpg" },
  { id: 119, name: "Buxy Select", code: "SE07", brand: "infinity", type: "Porcelain", colour: "Grey", pattern: "Textured", finish: ["Honed"], apps: ["Cladding", "Kitchens", "Outdoor"], img: "images/infinity/BuxySelect_SE07.jpg" },
  // Concrete Effect Series
  { id: 120, name: "Concrete Light", code: "CE01", brand: "infinity", type: "Porcelain", colour: "Beige", pattern: "Solid", finish: ["Honed"], apps: ["Kitchens", "Cladding", "Bathrooms"], img: "images/infinity/Infinity_CE01_Concrete_Light_400x800.jpg" },
  { id: 121, name: "Concrete Grey", code: "CE02", brand: "infinity", type: "Porcelain", colour: "Grey", pattern: "Solid", finish: ["Honed"], apps: ["Kitchens", "Cladding", "Bathrooms"], img: "images/infinity/Infinity_CE02_Concrete_Grey_160x320_12mm.jpg" },
  // Solid Colour Series
  { id: 122, name: "Absolute White", code: "SC01", brand: "infinity", type: "Porcelain", colour: "White", pattern: "Solid", finish: ["Polished"], apps: ["Kitchens", "Cladding", "Bathrooms"], img: "images/infinity/Infinity_SC01_Absolute_White_160x320_12mm.jpg" },
  { id: 123, name: "Absolute Black", code: "SC02", brand: "infinity", type: "Porcelain", colour: "Black", pattern: "Solid", finish: ["Polished"], apps: ["Kitchens", "Cladding", "Bathrooms"], img: "images/infinity/Infinity_SC02_Absolute_Black_400x800-2.jpg" },
  // Metal Effect Series
  { id: 124, name: "Metal Silver", code: "ME01", brand: "infinity", type: "Porcelain", colour: "Grey", pattern: "Textured", finish: ["Honed"], apps: ["Cladding", "Kitchens"], img: "images/infinity/Infinity_ME01_Metal_Silver_400x800.jpg" },
  { id: 125, name: "Metal Dark", code: "ME02", brand: "infinity", type: "Porcelain", colour: "Black", pattern: "Textured", finish: ["Honed"], apps: ["Cladding", "Kitchens"], img: "images/infinity/Infinity_ME02_Metal_Dark_160x320_12mm.jpg" },
];
...
const PROJECTS = [
  ...
  { id: 4, slug: "durban-north-cladding", title: "Durban North Feature Wall", type: "Cladding", material: "Basalt Black", brand: "Neolith", location: "Durban North", desc: "A 12m\u00B2 feature wall in Neolith Basalt Black with a leathered finish. The large-format porcelain panels were installed with minimal visible joints, creating a monolithic textured surface in this contemporary living room.", img: "linear-gradient(135deg, #222222 0%, #333333 50%, #1a1a1a 100%)" },
...
const SERVICES = [
  { slug: "kitchens", name: "Kitchens", headline: "Kitchen Countertops & Surfaces", subhead: "From engineered quartz to ultra-compact porcelain — we supply, fabricate, and install kitchen surfaces built to last.", intro: "Your kitchen countertop is the hardest-working surface in your home — and it should look the part. We supply, fabricate, and install stone surfaces for kitchens of every size and style, from compact apartment counters to expansive island installations. Choose from engineered quartz or ultra-compact porcelain. Every piece is precision-templated on site, CNC-fabricated in our Durban workshop, and installed by our own team.", icon: "◻", apps: ["Kitchens"], faq: [
    { q: "What materials are best for kitchen countertops?", a: "Quartz and porcelain are the most popular choices for kitchens due to their durability, stain resistance, and low maintenance. We'll help you choose based on your usage, aesthetic preference, and budget." },
  ...
  { slug: "vanities", name: "Vanities", headline: "Bathroom Vanity Tops & Surfaces", subhead: "Elegant, durable surfaces for bathrooms — vanity tops, shower walls, bath surrounds, and shelving.", intro: "A beautifully finished vanity top elevates your entire bathroom. We fabricate and install stone surfaces for vanity tops, shower walls, bath surrounds, and shelving — in materials chosen for water resistance, durability, and visual impact. Whether it's a single guest bathroom or a full residential fit-out, we handle the full scope from slab selection to final installation.", icon: "◻", apps: ["Bathrooms"], faq: [
    { q: "Are stone vanity tops waterproof?", a: "Quartz and porcelain are non-porous and highly water-resistant. We advise on the best material for your bathroom environment." },
  ...
  { slug: "staircases", name: "Staircases", headline: "Stone Staircases & Treads", subhead: "Precision-fabricated stone treads, risers, and cladding for staircases that make a statement.", intro: "A stone staircase makes a statement. We fabricate precision-cut treads, risers, and landing slabs in porcelain and engineered quartz. Every component is templated to your exact dimensions, finished to your chosen edge profile, and installed to deliver a seamless result. We work closely with builders and structural engineers to ensure weight, support, and fit are exactly right.", icon: "△", apps: ["Staircases"], faq: [
  ...
  { slug: "cladding", name: "Cladding", headline: "Porcelain & Stone Cladding", subhead: "Interior and exterior wall cladding in engineered quartz and ultra-compact porcelain surfaces.", intro: "Porcelain cladding transforms walls into features. We supply and install interior and exterior cladding in engineered quartz and ultra-compact porcelain surfaces like Neolith. Large-format panels create clean, contemporary lines. We advise on material suitability for your specific environment — UV exposure, moisture, traffic, and structural load.", icon: "▮", apps: ["Cladding"], faq: [
    { q: "Can porcelain cladding be used outdoors?", a: "Yes. Porcelain surfaces (such as Neolith) are UV-stable, frost-resistant, and suitable for exterior cladding." },
    { q: "What panel sizes are available?", a: "Porcelain slabs are available in large formats up to 3.2m x 1.5m, allowing for minimal joints. We'll advise on the best format for your wall dimensions." },
  ]},
];
  ...
  return (
    <>
      <Hero
        ...
        sub="Porcelain & quartz surfaces — supplied, fabricated and installed across KwaZulu-Natal. From kitchen countertops to architectural cladding, we bring your vision to life."
  ...
  return (
    <>
      ...
      <Section bg="white" padY={48}>
        <SectionTitle title="Materials" sub="Browse our full range of porcelain and quartz surfaces." />
