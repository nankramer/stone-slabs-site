...
// ============================================================
const BRANDS = [
  { slug: "neolith", name: "Neolith", tagline: "Ultra-compact sintered stone from Spain", desc: "Neolith is a revolutionary sintered stone surface made from 100% natural raw materials. With 36 colours spanning elegant Calacattas, dramatic blacks, industrial metals, and natural stone effects, Neolith is resistant to UV, scratches, chemicals, and extreme temperatures — ideal for kitchens, cladding, flooring, and facades." },
  ...
  { slug: "proquartz", name: "Proquartz", tagline: "Premium quartz surfaces", desc: "Proquartz delivers premium engineered quartz with exceptional consistency and finish. Their range spans from classic solids to dramatic veined patterns that replicate natural marble at a fraction of the maintenance." },
  ...
  { slug: "estrella", name: "Estrella", tagline: "Quartz surfaces", desc: "Estrella quartz surfaces combine quality with design, offering a curated range of 25 colours and patterns — from dramatic veined Calacattas and bold blacks to warm beiges and statement blues — suited to both residential and commercial projects." },
  { slug: "lutum", name: "Lutum", tagline: "Sintered stone", desc: "Lutum sintered stone surfaces are manufactured using cutting-edge technology to produce ultra-compact slabs with exceptional durability, heat resistance, and design versatility. The 10-colour range spans dramatic veined marbles, rich greens, deep blacks, warm travertines, and industrial concretes." },
  { slug: "caesarstone", name: "Caesarstone", tagline: "Engineered quartz surfaces", desc: "Caesarstone pioneered the engineered quartz category and continues to set the standard for quality, innovation, and design. Their surfaces are found in homes and commercial spaces worldwide." },
];

const MATERIALS = [
  // --- Caesarstone ---
  { id: 1, name: "Statuario Maximus", brand: "caesarstone", type: "Quartz", colour: "White", pattern: "Veined", finish: ["Polished", "Honed"], apps: ["Kitchens", "Bathrooms", "Cladding"], img: "linear-gradient(135deg, #f5f5f0 0%, #e8e4dc 30%, #f0ece4 50%, #d4cfc5 70%, #f5f2ec 100%)" },
  { id: 5, name: "Sahara Beige", brand: "caesarstone", type: "Quartz", colour: "Beige", pattern: "Speckled", finish: ["Polished"], apps: ["Kitchens", "Bathrooms"], img: "linear-gradient(135deg, #d4c5a9 0%, #c8b899 50%, #ddd0b8 100%)" },
  { id: 7, name: "Bianco Drift", brand: "caesarstone", type: "Quartz", colour: "White", pattern: "Veined", finish: ["Polished", "Honed"], apps: ["Kitchens", "Bathrooms", "Staircases"], img: "linear-gradient(135deg, #f0ede8 0%, #ddd8d0 40%, #ece8e0 70%, #d8d2c8 100%)" },
  { id: 15, name: "Statuario Nuvo", brand: "caesarstone", type: "Quartz", colour: "White", pattern: "Veined", finish: ["Polished"], apps: ["Kitchens", "Bathrooms"], img: "linear-gradient(135deg, #f5f2ed 0%, #e0d8cc 30%, #f0ebe2 55%, #d8d0c2 100%)" },
  ...
  // --- Proquartz ---
  { id: 3, name: "Calacatta Gold", brand: "proquartz", type: "Quartz", colour: "White", pattern: "Veined", finish: ["Polished"], apps: ["Kitchens", "Bathrooms"], img: "linear-gradient(135deg, #faf8f4 0%, #e8ddd0 40%, #f5f0e8 60%, #ddd4c4 100%)" },
  { id: 9, name: "Emperador Dark", brand: "proquartz", type: "Quartz", colour: "Brown", pattern: "Veined", finish: ["Polished"], apps: ["Kitchens", "Bathrooms", "Staircases"], img: "linear-gradient(135deg, #4a3628 0%, #5c4435 40%, #3d2a1e 70%, #5c4435 100%)" },
  { id: 16, name: "Midnight Blue", brand: "proquartz", type: "Quartz", colour: "Blue", pattern: "Speckled", finish: ["Polished"], apps: ["Bathrooms", "Kitchens"], img: "linear-gradient(135deg, #1a2a4a 0%, #253a5c 50%, #1a2a4a 100%)" },
  // --- Eezi Quartz ---
  { id: 4, name: "Atlantic Grey", brand: "eezi-quartz", type: "Quartz", colour: "Grey", pattern: "Speckled", finish: ["Polished", "Honed"], apps: ["Kitchens", "Bathrooms", "Staircases"], img: "linear-gradient(135deg, #8a8a8a 0%, #9e9e9e 30%, #7a7a7a 60%, #9a9a9a 100%)" },
  { id: 10, name: "Arctic White", brand: "eezi-quartz", type: "Quartz", colour: "White", pattern: "Solid", finish: ["Polished", "Honed"], apps: ["Kitchens", "Bathrooms"], img: "linear-gradient(135deg, #fafafa 0%, #f0f0f0 50%, #fafafa 100%)" },
  ...
  { id: 200, name: "Absolute White", brand: "estrella", type: "Quartz", colour: "White", pattern: "Solid", finish: ["Polished"], apps: ["Kitchens", "Bathrooms"], img: "images/estrella/Absolute_White.png" },
  { id: 201, name: "Amani Crema", brand: "estrella", type: "Quartz", colour: "Beige", pattern: "Veined", finish: ["Polished"], apps: ["Kitchens", "Bathrooms"], img: "images/estrella/Amani_Crema.png" },
  { id: 202, name: "Amani Grey", brand: "estrella", type: "Quartz", colour: "Grey", pattern: "Veined", finish: ["Polished"], apps: ["Kitchens", "Bathrooms", "Staircases"], img: "images/estrella/Amani_Grey.png" },
  { id: 203, name: "Ankara", brand: "estrella", type: "Quartz", colour: "White", pattern: "Veined", finish: ["Polished"], apps: ["Kitchens", "Bathrooms"], img: "images/estrella/Ankara.png" },
  { id: 204, name: "Arabescato Corchia", brand: "estrella", type: "Quartz", colour: "White", pattern: "Veined", finish: ["Polished"], apps: ["Kitchens", "Bathrooms", "Cladding"], img: "images/estrella/Arabescato_Corchia.png" },
  { id: 205, name: "Basalt Black", brand: "estrella", type: "Quartz", colour: "Black", pattern: "Solid", finish: ["Polished", "Honed"], apps: ["Kitchens", "Bathrooms", "Cladding"], img: "images/estrella/Basalt_Black.png" },
  { id: 206, name: "Brown Positano", brand: "estrella", type: "Quartz", colour: "Brown", pattern: "Textured", finish: ["Polished"], apps: ["Kitchens", "Bathrooms"], img: "images/estrella/Brown_Positano.png" },
  { id: 207, name: "Calacatta Black", brand: "estrella", type: "Quartz", colour: "Black", pattern: "Veined", finish: ["Polished"], apps: ["Kitchens", "Bathrooms", "Cladding"], img: "images/estrella/Calacatta_Black.png" },
  { id: 208, name: "Calacatta Butterfly", brand: "estrella", type: "Quartz", colour: "White", pattern: "Veined", finish: ["Polished"], apps: ["Kitchens", "Bathrooms"], img: "images/estrella/Calacatta_Butterfly.png" },
  { id: 209, name: "Calacatta Extra", brand: "estrella", type: "Quartz", colour: "White", pattern: "Veined", finish: ["Polished"], apps: ["Kitchens", "Bathrooms"], img: "images/estrella/Calacatta_Extra.png" },
  { id: 210, name: "Calacatta Gold", brand: "estrella", type: "Quartz", colour: "White", pattern: "Veined", finish: ["Polished"], apps: ["Kitchens", "Bathrooms"], img: "images/estrella/Calacatta_Gold.png" },
  { id: 211, name: "Emperor Onyx", brand: "estrella", type: "Quartz", colour: "Beige", pattern: "Veined", finish: ["Polished"], apps: ["Kitchens", "Bathrooms", "Cladding"], img: "images/estrella/Emperor_Onyx.png" },
  { id: 212, name: "Galaxy", brand: "estrella", type: "Quartz", colour: "Grey", pattern: "Veined", finish: ["Polished"], apps: ["Kitchens", "Bathrooms"], img: "images/estrella/Galaxy.png" },
  { id: 213, name: "Galaxy Beige", brand: "estrella", type: "Quartz", colour: "Beige", pattern: "Veined", finish: ["Polished"], apps: ["Kitchens", "Bathrooms"], img: "images/estrella/Galaxy_Beige.png" },
  { id: 214, name: "Illumina Stone", brand: "estrella", type: "Quartz", colour: "Grey", pattern: "Veined", finish: ["Polished"], apps: ["Kitchens", "Bathrooms", "Staircases"], img: "images/estrella/Illumina_Stone.png" },
  { id: 215, name: "Kylin", brand: "estrella", type: "Quartz", colour: "Green", pattern: "Veined", finish: ["Polished"], apps: ["Kitchens", "Bathrooms", "Cladding"], img: "images/estrella/Kylin.png" },
  { id: 216, name: "Lassi Transparenti", brand: "estrella", type: "Quartz", colour: "White", pattern: "Veined", finish: ["Polished"], apps: ["Kitchens", "Bathrooms"], img: "images/estrella/Lassi_Transparenti.png" },
  { id: 217, name: "Luxe Firenze", brand: "estrella", type: "Quartz", colour: "White", pattern: "Veined", finish: ["Polished"], apps: ["Kitchens", "Bathrooms"], img: "images/estrella/Luxe_Firenze.png" },
  { id: 218, name: "Nero Elegance", brand: "estrella", type: "Quartz", colour: "Black", pattern: "Veined", finish: ["Polished"], apps: ["Kitchens", "Bathrooms", "Cladding"], img: "images/estrella/Nero_Elegance.png" },
  { id: 219, name: "Ocean Blue", brand: "estrella", type: "Quartz", colour: "Blue", pattern: "Veined", finish: ["Polished"], apps: ["Bathrooms", "Cladding"], img: "images/estrella/Ocean_Blue.png" },
  { id: 220, name: "Onice White", brand: "estrella", type: "Quartz", colour: "White", pattern: "Veined", finish: ["Polished"], apps: ["Kitchens", "Bathrooms"], img: "images/estrella/Onice_White.png" },
  { id: 221, name: "Pandora", brand: "estrella", type: "Quartz", colour: "White", pattern: "Veined", finish: ["Polished"], apps: ["Kitchens", "Bathrooms", "Cladding"], img: "images/estrella/Pandora.png" },
  { id: 222, name: "Savoia Antracite", brand: "estrella", type: "Quartz", colour: "Grey", pattern: "Textured", finish: ["Polished", "Honed"], apps: ["Kitchens", "Bathrooms", "Cladding"], img: "images/estrella/Savoia_Antracite.png" },
  { id: 223, name: "Taj Mahal", brand: "estrella", type: "Quartz", colour: "White", pattern: "Veined", finish: ["Polished"], apps: ["Kitchens", "Bathrooms"], img: "images/estrella/Taj_Mahal.png" },
  { id: 224, name: "Travertino Classico", brand: "estrella", type: "Quartz", colour: "White", pattern: "Veined", finish: ["Polished"], apps: ["Kitchens", "Bathrooms", "Cladding"], img: "images/estrella/Travertino_Classico.png" },
...
const PROJECTS = [
  { id: 1, slug: "umhlanga-modern-kitchen", title: "Umhlanga Modern Kitchen", type: "Kitchen", material: "Statuario Maximus", brand: "Caesarstone", location: "Umhlanga", desc: "A sweeping 4.2m island in Caesarstone Statuario Maximus with waterfall edges, paired with a matching perimeter countertop and integrated splashback. The veined pattern was bookmatched across the waterfall for visual continuity.", img: "linear-gradient(135deg, #2a2420 0%, #4a4035 40%, #3a3028 100%)" },
  { id: 2, slug: "ballito-bathroom-suite", title: "Ballito Bathroom Suite", type: "Bathroom", material: "Bianco Drift", brand: "Caesarstone", location: "Ballito", desc: "Full bathroom renovation including double vanity top, shower niche shelving, and a freestanding bath surround. Caesarstone Bianco Drift selected for its subtle movement and water resistance.", img: "linear-gradient(135deg, #e8e4dc 0%, #d4cfc5 50%, #e8e4dc 100%)" },
  { id: 3, slug: "hillcrest-staircase", title: "Hillcrest Residence Staircase", type: "Staircase", material: "Emperador Dark", brand: "Proquartz", location: "Hillcrest", desc: "A dramatic floating staircase clad in Proquartz Emperador Dark. 14 treads with bullnose edges, precision-templated on site and fabricated to 0.5mm tolerance. Structural coordination with the builder was critical.", img: "linear-gradient(135deg, #4a3628 0%, #3d2a1e 50%, #5c4435 100%)" },
  ...
  { id: 5, slug: "umhlanga-commercial-reception", title: "Umhlanga Office Reception", type: "Commercial", material: "Calacatta Gold", brand: "Proquartz", location: "Umhlanga", desc: "Reception desk and full-height wall cladding in Proquartz Calacatta Gold for a professional services firm. The veined pattern was carefully aligned across the desk front and wall panels for a seamless visual effect.", img: "linear-gradient(135deg, #faf8f4 0%, #e8ddd0 50%, #f5f0e8 100%)" },
];

const SERVICES = [
  { slug: "kitchens", name: "Kitchens", headline: "Kitchen Countertops & Surfaces", subhead: "From classic granite to ultra-compact sintered stone — we supply, fabricate, and install kitchen surfaces built to last.", intro: "Your kitchen countertop is the hardest-working surface in your home — and it should look the part. We supply, fabricate, and install stone surfaces for kitchens of every size and style, from compact apartment counters to expansive island installations. Choose from natural granite and marble, engineered quartz, or ultra-compact sintered stone. Every piece is precision-templated on site, CNC-fabricated in our Durban workshop, and installed by our own team.", icon: "◻", apps: ["Kitchens"], faq: [
    { q: "What materials are best for kitchen countertops?", a: "Quartz and sintered stone are the most popular choices for kitchens due to their durability, stain resistance, and low maintenance. Natural granite remains a classic option. We'll help you choose based on your usage, aesthetic preference, and budget." },
  ...
  { slug: "vanities", name: "Vanities", headline: "Bathroom Vanity Tops & Surfaces", subhead: "Elegant, durable surfaces for bathrooms — vanity tops, shower walls, bath surrounds, and shelving.", intro: "A beautifully finished vanity top elevates your entire bathroom. We fabricate and install stone surfaces for vanity tops, shower walls, bath surrounds, and shelving — in materials chosen for water resistance, durability, and visual impact. Whether it's a single guest bathroom or a full residential fit-out, we handle the full scope from slab selection to final installation.", icon: "◻", apps: ["Bathrooms"], faq: [
    { q: "Are stone vanity tops waterproof?", a: "Quartz and sintered stone are non-porous and highly water-resistant. Natural stone like marble and granite should be sealed to protect against moisture absorption. We advise on the best material for your bathroom environment." },
  ...
  { slug: "staircases", name: "Staircases", headline: "Stone Staircases & Treads", subhead: "Precision-fabricated stone treads, risers, and cladding for staircases that make a statement.", intro: "A stone staircase makes a statement. We fabricate precision-cut treads, risers, and landing slabs in granite, marble, and engineered stone. Every component is templated to your exact dimensions, finished to your chosen edge profile, and installed to deliver a seamless result. We work closely with builders and structural engineers to ensure weight, support, and fit are exactly right.", icon: "△", apps: ["Staircases"], faq: [
  ...
  { slug: "cladding", name: "Cladding", headline: "Stone & Sintered Cladding", subhead: "Interior and exterior wall cladding in natural stone, engineered quartz, and ultra-compact sintered surfaces.", intro: "Stone and sintered cladding transforms walls into features. We supply and install interior and exterior cladding in natural stone, engineered quartz, and ultra-compact sintered surfaces like Neolith. Large-format panels create clean, contemporary lines; natural stone brings warmth and texture. We advise on material suitability for your specific environment — UV exposure, moisture, traffic, and structural load.", icon: "▮", apps: ["Cladding"], faq: [
    { q: "Can stone cladding be used outdoors?", a: "Yes. Sintered stone (such as Neolith) is UV-stable, frost-resistant, and suitable for exterior cladding. Natural stone can also be used outdoors depending on the specific material and climate conditions." },
    ...
    <div style={{ padding: embedded ? 0 : '32px' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 16 }}>
        ...
        <div>
          ...
          <input style={inputStyle('material')} value={form.material} onChange={e => update('material', e.target.value)} placeholder="e.g. Caesarstone Statuario" />
        </div>
      </div>
  ...
  return (
    <>
      <Hero
        ...
        sub="Granite, marble, quartz & sintered stone — supplied, fabricated and installed across KwaZulu-Natal. From kitchen countertops to architectural cladding, we bring your vision to life in stone."
  ...
  return (
    <>
      ...
      <Section bg="white" padY={48}>
        <SectionTitle title="Materials" sub="Browse our full range of granite, marble, quartz, and sintered stone surfaces." />
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16, marginBottom: 32, padding: 24, background: 'var(--stone-50)', borderRadius: 14, border: '1px solid var(--stone-100)' }}>
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8, alignItems: 'center' }}>
            ...
            {['Quartz', 'Sintered Stone', 'Porcelain', 'Granite', 'Marble'].map(t => (
